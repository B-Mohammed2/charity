...
SECRET_KEY = 'django-insecure-6#!(4&3p51-kl7sy#g#v*^ba-$5$sv)o1lxpnu0tn&)v5qtr3&'
...
MIDDLEWARE = [
    ...
    #define a list of middleware classes that are applied to incoming HTTP requests and outgoing responses. 
...
# log emails to the console to get confirmation links.
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')] # The filesystem path where static files are stored.
